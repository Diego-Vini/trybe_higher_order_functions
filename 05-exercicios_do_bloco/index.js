...
const expectedResultSort = [
  ...
  function booksOrderedByReleaseYearDesc() {
    return books.sort((bookName_A, bookName_B) => bookName_B.releaseYear - bookName_A.releaseYear)
  }
  
  assert.deepStrictEqual(booksOrderedByReleaseYearDesc(), expectedResultSort);